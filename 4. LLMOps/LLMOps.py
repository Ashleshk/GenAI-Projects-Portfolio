...
prod_data_path = f"{DA.paths.working_dir}/m7_prod_data"
...
mlflow.set_experiment(f"/Users/{DA.username}/GenAI-07-LLMOps")
...
inference_results_path = f"{DA.paths.working_dir}/m7-inference-results".replace(
    "/dbfs", "dbfs:"
)
