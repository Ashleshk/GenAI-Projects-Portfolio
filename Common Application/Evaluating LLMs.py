...
# MAGIC This notebook demonstrates methods for evaluating LLMs.  We focus on the task of summarization and cover of **accuracy, ROUGE-N, and perplexity**.
# MAGIC
# MAGIC ## Learning Objectives
# MAGIC
# MAGIC By the end of this demo, you should be able to:
# MAGIC
# MAGIC 1. Compute ROUGE-N and other alternative evaluation metrics.
# MAGIC 1. Gain an intuitive understanding of ROUGE-N.
# MAGIC 1. Test various models and model sizes on the same data, and compare their results.
...
# MAGIC %md 
# MAGIC ### How can we evaluate summarization?
# MAGIC
...
# Use a small sample of the data during this demo, for speed.
sample_size = 100
sample = (
    full_dataset
...
# MAGIC %md 
# MAGIC ### Understanding ROUGE scores
...
# MAGIC ## Summary
# MAGIC
# MAGIC In this demo, we demonstrated how to evaluate an LLM model's summarization performance. After completing a summarization task, we computed the ROUGE score for the model and discussed methods for interpreting these scores and their significance. In the final section, we compared multiple models based on their respective ROUGE scores.
